...
1) Interface grafica DONE
2) Implementar unbind no Peer.java  DONE
3) Peer.java deve ser capaz de escolher o peer. DONE
4) Pelo menos 1 (um) novo peer deve ser adicionado no enum PeerLista. DONE
